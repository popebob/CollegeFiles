...
// OR this:
  ...
  if (I am child) {
//    get into an "infinite" loop  to receive messages and print
//    them.  Quit when you receive a quit.
  }
  else (I am the parent) {
//    get into an infinite loop to send whatever you type.
//    Make sure to parse out the ".send" and ".quit" commands and
//    act (send) accordingly.
  }
}
